...
st.markdown(
    ...
    - 🧠 **Wisdom** and **creativity** that inspire the world.
    - 💪 **Strength** and **courage** that uplift communities.
    - 💖 **Kindness** and **compassion** that make the world a better place.
    
    Take a moment to reflect, celebrate, and spread love. 🌸
    
    """
)

st.info("Made with love by Taha Qureshi 💜")
